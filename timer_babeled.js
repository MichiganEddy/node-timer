...
var programInit = function programInit() {
...
var authStartTimer = function authStartTimer(timerSetting) {
...
var runSwitch = function runSwitch(userResponse, timerSetting) {
  switch (userResponse) {
    case 'y':
...
// countdown from
var countdown = function countdown(count, timerSetting) {
  if (count == 0) {
...
var timerStart = function timerStart(timerSetting) {
  setTimeout(function () {
    spinner.stop();
    var alertString = '**************************************\n';
...
var getMilis = function getMilis(s) {
  return s * 1000;
};

// FUNCTION - errFunc --> report an error and exit.
var errFunc = function errFunc(functionName, error) {
